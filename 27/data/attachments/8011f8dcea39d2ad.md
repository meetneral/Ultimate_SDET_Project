...
- Name: Authencity.spec.ts >> Homepage >> Protien check
- Location: tests/spec/MuscleBlaze/Authencity.spec.ts:39:7
...
Locator: getByRole('cell', { name: 'AIZDVF0050' })
Expected: visible
Error: strict mode violation: getByRole('cell', { name: 'AIZDVF0050' }) resolved to 2 elements:
    1) <td>AIZDVF0050</td> aka getByRole('cell', { name: 'AIZDVF0050' }).first()
    2) <td>AIZDVF0050</td> aka getByRole('cell', { name: 'AIZDVF0050' }).nth(1)

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for getByRole('cell', { name: 'AIZDVF0050' })
